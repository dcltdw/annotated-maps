...
│       ├── token-refresh.spec.ts             # axios 401 → refresh → retry interceptor (#168)
│       ├── sso-initiate.spec.ts              # SSO initiate UI on login form (#167)
│       ├── maps.spec.ts                      # map CRUD via UI (#35, #102)
│       ├── map-edit-delete.spec.ts           # map title/description edit + delete (#160)
│       ├── map-sharing.spec.ts               # map permissions / sharing modal (#161)
│       ├── coordinate-systems.spec.ts        # pixel + blank renderers (#128)
│       ├── coordinate-systems-crud.spec.ts   # cross-coord-system CRUD lock-in (#170)
...
│       ├── note-pin-toggle.spec.ts           # note pin/unpin inline toggle (#107)
...
│       ├── tenant-branding.spec.ts           # tenant branding editor on /admin (#163)
│       ├── tenant-members.spec.ts            # tenant member management on /members (#162)
